"""Character creation and character training module.
Play serouis.
"""
...
def special(char_name: str, char_class: str) -> str:
    """Character special ability description."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Character training process description."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Choice class function description."""
    approve_choice: str = ''
    char_class: str = ''
